'''ere is an OOP approach that creates a collection of Ball objects, keeps track of them on the canvas, and updates them at each turn.'''
...
class Ball:
    ...
    def __init__(self):
        ...
        self.ypos = random.randint(0, 1000)
...
class MyCanvas(tk.Canvas):
    ...
    def __init__(self, master):
        ...
        super().__init__(master, width=650, height=1500, bg="black", bd=0, highlightthickness=0, relief="ridge")
        self.pack()
        ...
        for _ in range(100):
            ...
            self.bs.append(self.create_oval(ball.xpos - 10, ball.ypos - 10, ball.xpos + 10, ball.ypos + 10, fill="cyan"))
        self.run()
